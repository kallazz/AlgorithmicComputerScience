...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		...
		bookstoreFacade.setBookService(bookService);
		bookstoreFacade.setCustomerService(customerService);
		bookstoreFacade.setCustomerNotificationService(customerNotificationService);
		bookstoreFacade.setOrderingService(orderingService);
		bookstoreFacade.setWarehouseService(warehouseService);
