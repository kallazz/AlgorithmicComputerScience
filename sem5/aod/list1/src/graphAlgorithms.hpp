...
void bfs(const Graph& graph, const int startVertex, const bool printFlag = false);
void dfs(const Graph& graph, const int startVertex, const bool printFlag = false);
