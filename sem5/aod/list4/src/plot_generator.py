...
EDMONDS_KARP_RESULT_FILENAME = "edmondsKarpResults.csv"
...
def main() -> None:
    plot_names = ["Średni czas wykonania Edmondsa-Karpa", "Średnia wartość maksymalnego przepływu", "Średnia ilość wyliczonych ścieżek powiększających"]
    ...
    generate_plots_for_edmonds_karp(plot_names, DATA_DIR + EDMONDS_KARP_RESULT_FILENAME, output_file_names)
