...
from rc4 import RC4, were_texts_encrypted_using_the_same_key
...
class TestRC4:
    ...
    def test_same_keys(self):
        for _ in range(TEST_REPEATS):
            ...
            assert were_texts_encrypted_using_the_same_key(ciphertext1, ciphertext2) == True
            assert were_texts_encrypted_using_the_same_key(ciphertext1, ciphertext3) == False
            assert were_texts_encrypted_using_the_same_key(ciphertext2, ciphertext3) == False
