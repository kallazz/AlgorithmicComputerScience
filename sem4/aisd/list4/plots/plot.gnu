...
plot "keyComparisonsAscending.txt" using 1:2 with lines title "Binary Search Tree", \
     "keyComparisonsAscending.txt" using 1:3 with lines linewidth 3 linecolor "red" title "Red-Black Tree", \
     "keyComparisonsAscending.txt" using 1:4 with lines linewidth 3 title "Splay Tree"
...
plot "keyComparisons.txt" using 1:2 with lines title "Binary Search Tree", \
     "keyComparisons.txt" using 1:3 with lines linecolor "red" title "Red-Black Tree", \
...
plot "pointerOperationsAscending.txt" using 1:2 with lines title "Binary Search Tree", \
     "pointerOperationsAscending.txt" using 1:3 with lines linewidth 3 linecolor "red" title "Red-Black Tree", \
     "pointerOperationsAscending.txt" using 1:4 with lines linewidth 3 title "Splay Tree"
...
plot "pointerOperations.txt" using 1:2 with lines title "Binary Search Tree", \
     "pointerOperations.txt" using 1:3 with lines linecolor "red" title "Red-Black Tree", \
...
plot "heightsAscending.txt" using 1:2 with lines title "Binary Search Tree", \
     "heightsAscending.txt" using 1:3 with lines linewidth 3 linecolor "red" title "Red-Black Tree", \
     "heightsAscending.txt" using 1:4 with lines linewidth 3 title "Splay Tree"
...
plot "heights.txt" using 1:2 with lines title "Binary Search Tree", \
     "heights.txt" using 1:3 with lines linecolor "red" title "Red-Black Tree", \
